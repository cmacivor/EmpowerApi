...
# 
$ProjectFile = "..\DJSAdultCaseMgtService\DJSAdultCaseMgtService.csproj"
...
$Properties = "/p:Configuration=Release;PublishProfile=AdultPackage;DeployOnBuild=True;VisualStudioVersion=14.0"
