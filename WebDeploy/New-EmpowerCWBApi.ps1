...
# 
$ProjectFile = "..\CWBCaseMgtService\CWBCaseMgtService.csproj"
...
$Properties = "/p:Configuration=Release;PublishProfile=CWBPackage;DeployOnBuild=True;VisualStudioVersion=14.0"
