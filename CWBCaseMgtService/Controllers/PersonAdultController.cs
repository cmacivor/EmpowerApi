...
namespace DJSCaseMgtService.Controllers
{
    ...
    [RoutePrefix("api/PersonAdult")]
  

    public class PersonAdultController : ApiController 
    {
        private IPersonAdultRepository personRepository;
        ...
        public PersonAdultController(IPersonAdultRepository personRepository,
        ...
        public async Task<object> Create(PersonAdult person)
        {


            ClientAdult clientProfile = new ClientAdult
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (jtsresult == null && ssnresult == null)
                {
                    ...
                    if (person.ID != 0)
                    {
                        ...
                        clientAdultProfileRepository.Create(clientProfile);
                        var cpVal = await clientAdultProfileRepository.Save();
        ...
        public async Task<object> Update(PersonAdult person)
        {
