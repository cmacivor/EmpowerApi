...
{
    public class ClientAdultProfileRepository : BaseRepository<ClientAdult>, IClientAdultProfileRepository
    {
        private DJSCaseMgtContext context;

        public ClientAdultProfileRepository(DJSCaseMgtContext context) : base(context)
        {
    ...
    public interface IClientAdultProfileRepository : IBaseRepository<ClientAdult>
    {
