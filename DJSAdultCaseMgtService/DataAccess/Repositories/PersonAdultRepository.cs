...
{
    public class PersonAdultRepository : BaseRepository<PersonAdult>, IPersonAdultRepository
    {
        private DJSCaseMgtContext context;

        public PersonAdultRepository(DJSCaseMgtContext context) : base(context) 
        {
            this.context = context;
        }        

        public PersonAdultViewModel GetPersonForClientProfile(int clientProfileID)
        {
            // Create new instance of PersonViewModel
            // PersonViewModel personVM = new PersonViewModel();
            PersonAdultViewModel personVM = new PersonAdultViewModel();
            try {
    ...
    public interface IPersonAdultRepository : IBaseRepository<PersonAdult>
    {
        PersonAdultViewModel GetPersonForClientProfile(int clientProfileID);
